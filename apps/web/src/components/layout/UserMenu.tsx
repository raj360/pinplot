...
export function UserMenu({ initials, displayName, onSignOut }: UserMenuProps) {
  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        type="button"
        className="user-avatar flex size-8 shrink-0 cursor-pointer items-center justify-center rounded-full border-2 border-primary-foreground/40 bg-primary-foreground/15 text-[11px] font-semibold text-primary-foreground"
